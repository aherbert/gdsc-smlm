...
public class ConfigurationTemplate implements PlugIn, DialogListener, ImageListener
{
     ...
     * benchmarking on a specific image. Those can be added to the /uk/ac/sussex/gdsc/smlm/templates/ resources
     * directory.
     *
     * @param name
     *            the name
    ...
    private static void restoreLoadedTemplates()
    {
        ...
        final DefaultTemplateSettings settings = SettingsManager
                .readDefaultTemplateSettings(SettingsManager.FLAG_SILENT);
    ...
    public void run(String arg)
    {
        ...
        final ConfigurationTemplateSettings.Builder settings = SettingsManager.readConfigurationTemplateSettings(0)
                .toBuilder();
    ...
    private void removeLoadedTemplates()
    {
        ...
        final MultiDialog md = new MultiDialog("Select templates to remove", new MultiDialog.BaseItems()
        {
            @Override
            public int size()
            {
