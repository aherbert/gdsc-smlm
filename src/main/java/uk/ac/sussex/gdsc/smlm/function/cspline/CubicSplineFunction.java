...
public abstract class CubicSplineFunction implements Gradient2Function
{
	...
	protected class DoubleTargetSpline extends TargetSpline
	{
		 ...
		 * (non-Javadoc)
		 *
		 * @see uk.ac.sussex.gdsc.smlm.function.cspline.CubicSplineFunction.TargetSpline#computePowerTable(double, double, double,
		 * int)
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 *
		 * @see uk.ac.sussex.gdsc.smlm.function.cspline.CubicSplineFunction.TargetSpline#computeValue(uk.ac.sussex.gdsc.core.math.interpolation.
		 ...
		 * (non-Javadoc)
		 *
		 * @see uk.ac.sussex.gdsc.smlm.function.cspline.CubicSplineFunction.TargetSpline#computeValue1(uk.ac.sussex.gdsc.core.math.interpolation.
		 * CustomTricubicFunction)
		 */
		@Override
		 ...
		 * (non-Javadoc)
		 *
		 * @see uk.ac.sussex.gdsc.smlm.function.cspline.CubicSplineFunction.TargetSpline#computeValue2(uk.ac.sussex.gdsc.core.math.interpolation.
		 * CustomTricubicFunction)
		 */
		@Override
