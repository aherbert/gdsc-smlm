 ...
 */
public class WLSQLVMGradientProcedure5 extends WLSQLVMGradientProcedure
{
    /**
     * @param y
     ...
     *            Gradient function
     */
    public WLSQLVMGradientProcedure5(final double[] y, final double[] var, final Gradient1Function func)
    {
        super(y, var, func);
        if (n != 5)
