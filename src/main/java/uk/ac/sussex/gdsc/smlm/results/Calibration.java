...
class Calibration implements Cloneable {
  ...
  /**
   * Sets the field missing exception enabled flag. If true an exception will be thrown when
   * accessing a field that is missing.
   *
   * @param enabled the new field missing exception enabled flag
   */
  ...
  /**
   * Validate the calibration by calling each property setter with the current value. This will set
   * the valid flags to false if the current value is not valid.
   */
  ...
  /**
   * Sets the (ADUs/photon). Can be used to convert the signal in Analogue-to-Digital units (ADUs)
   * to photons.
   *
