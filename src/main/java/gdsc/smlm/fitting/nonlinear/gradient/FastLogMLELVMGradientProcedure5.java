 ...
 */
public class FastLogMLELVMGradientProcedure5 extends FastLogMLELVMGradientProcedure
{
	
	/**
	 * Instantiates a new fast log MLELVM gradient procedure 5.
	 *
	 * @param y            Data to fit (must be positive)
	 * @param func            Gradient function
	 * @param fastLog the fast log
	 */
	public FastLogMLELVMGradientProcedure5(final double[] y, final Gradient1Function func, FastLog fastLog)
	{
