 ...
 */
public abstract class PoissonGammaGaussianFisherInformation2 implements FisherInformation
{
	 ...
	 */
	public PoissonGammaGaussianFisherInformation2(double m, double s) throws IllegalArgumentException
	{
		this(m, s, 5);
	}
	 ...
	 *             If the standard deviation is not strictly positive
	 */
	public PoissonGammaGaussianFisherInformation2(double m, double s, double range) throws IllegalArgumentException
	{
	...
	public double getPoissonGammaGaussianI(double t) throws IllegalArgumentException
	{
		...
		list1.resetQuick();
		list2.resetQuick();
		G = PoissonGammaFunction.poissonGammaN(0, t, m, dG_dp);
		// Since convolution of the Gaussian at c=0 should only really apply to values c>=0 the
		// contribution at zero is halved.
		double c0factor = 0.5;
		list1.add(c0factor * G + dirac);
		list2.add(c0factor * dG_dp[0] - dirac);
