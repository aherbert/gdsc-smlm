 ...
 * <p>
 * This function allows any input value X to generate a probability, even if the value is between steps of the
 * scaled PMF of the poisson distribution, i.e. using a gain of 2 the integers 1, 3, 5, etc should have no probability
 * from the scaled Poisson PMF but this function portions the probability accordingly.
 */
