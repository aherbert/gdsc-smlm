...
public class CreateDataSettingsHelper {
  ...
  /**
   * Set the total gain (the EM-gain multiplied by the camera gain multiplied by the quantum
   * efficiency). If either gain is disabled then it will be ignored. A total gain of zero means no
   * gain is applied.
   */
   ...
   * multiplied by the quantum efficiency. If either gain is disabled then they will be ignored. A
   * total gain of zero means no gain is applied.
   *
  ...
  /**
   * Get the total gain (Count/Photon). This is equal to the EM-gain multiplied by the camera gain
   * multiplied by the quantum efficiency. If either gain is disabled then they will be ignored. If
   * the total gain is not above zero (due to invalid configuration) then 1 will be returned.
   *
