...
public class TSFPeakResultsWriter extends AbstractPeakResults
{
    ...
    static
    {
        ...
        cameraTypeMap[uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.EMCCD
                .ordinal()] = CameraType.EMCCD;
        cameraTypeMap[uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.SCMOS
        ...
        locationUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.DistanceUnit.PIXEL
                .ordinal()] = LocationUnits.PIXELS;
        intensityUnitsMap = new IntensityUnits[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit
                .values().length];
        intensityUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit.COUNT
