...
public class PeakResultTableModelFrame extends JFrame implements ActionListener
{
            ...
            ListSelectionModel selectionModel)
    {
        ...
        final int[] indices = (selectionModel != null) ? ListSelectionModelHelper.getSelectedIndices(selectionModel)
                : null;
    ...
    private void doShowOverlay()
    {
        ...
        try
        {
            ...
            if (list.length == 1)
            {
                ...
                final PointRoi roi = new PointRoi(converter.convert(p.getXPosition()),
