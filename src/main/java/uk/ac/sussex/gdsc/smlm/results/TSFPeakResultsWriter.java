...
public class TSFPeakResultsWriter extends AbstractPeakResults
{
	...
	static
	{
		...
		cameraTypeMap = new CameraType[uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.values().length];
		cameraTypeMap[uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.CCD.ordinal()] = CameraType.CCD;
		cameraTypeMap[uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.EMCCD.ordinal()] = CameraType.EMCCD;
		cameraTypeMap[uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.SCMOS.ordinal()] = CameraType.SCMOS;
		thetaUnitsMap = new ThetaUnits[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.AngleUnit.values().length];
		thetaUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.AngleUnit.RADIAN.ordinal()] = ThetaUnits.RADIANS;
		thetaUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.AngleUnit.DEGREE.ordinal()] = ThetaUnits.DEGREES;
		locationUnitsMap = new LocationUnits[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.DistanceUnit.values().length];
		locationUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.DistanceUnit.NM.ordinal()] = LocationUnits.NM;
		locationUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.DistanceUnit.UM.ordinal()] = LocationUnits.UM;
		locationUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.DistanceUnit.PIXEL.ordinal()] = LocationUnits.PIXELS;
		intensityUnitsMap = new IntensityUnits[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit.values().length];
		intensityUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit.COUNT.ordinal()] = IntensityUnits.COUNTS;
		intensityUnitsMap[uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit.PHOTON.ordinal()] = IntensityUnits.PHOTONS;
	}
