...
// NOTE
//
// This is a copy of the ij.gui.GenericDialog from ImageJ 1.50a
// It is included here to provide support for legacy plugins that manipulate
// the layout.
//
// Later versions of ImageJ (from 1.52g onwards) use a modified layout that
// cannot be updated using the same code. For compatibility 1.50a was chosen as
// this matches the project ImageJ dependency.
//
// Code has been removed that requires the class to reside in package ij.gui,
// or explicitly be a ij.gui.GenericDialog instance.
// This code is block commented out and commented with: 
// UNSUPPORTED
//
// The main change is lack of support for dialog listeners and the preview
// checkbox.
////////////////////////////////////////////////////////////////////////////////
...
*/
public class LegacyGenericDialog extends Dialog implements ActionListener, TextListener, 
...
//    private PlugInFilterRunner pfr;      // the PlugInFilterRunner for automatic preview
  ...
  public LegacyGenericDialog(String title) {
    ...
    public LegacyGenericDialog(String title, Frame parent) {
...
//        if (previewCheckbox!=null)
//          return;
//        throw new IllegalStateException("PlugInFilterRunner is not supported");
//      //ImagePlus imp = WindowManager.getCurrentImage();
//    //if (imp!=null && imp.isComposite() && ((CompositeImage)imp).getMode()==IJ.COMPOSITE)
//    //  return;
//        previewLabel = label;
...
//      throw new IllegalStateException("DialogListener is not supported");
