...
public class FastMleGradient2Procedure6 extends FastMleGradient2Procedure {
   ...
   *        Poisson process)
   */
  public FastMleGradient2Procedure6(final double[] x, final Gradient2Function func) {
    super(x, func);
  ...
  public void execute(double uk, double[] dukDt, double[] d2ukDt2) {
    ...
    d1[4] += dukDt[4] * xk_uk_minus1;
    d1[5] += dukDt[5] * xk_uk_minus1;
    ...
    d2[4] += d2ukDt2[4] * xk_uk_minus1 - dukDt[4] * dukDt[4] * xk_uk2;
    d2[5] += d2ukDt2[5] * xk_uk_minus1 - dukDt[5] * dukDt[5] * xk_uk2;
  }
