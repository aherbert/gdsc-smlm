...
{
	/** The default increment for the min width. Used for {@link uk.ac.sussex.gdsc.smlm.ga.Chromosome} interface. */
	public static final double DEFAULT_MIN_INCREMENT = 0.02;
	/** The default range for the min width. Used for {@link uk.ac.sussex.gdsc.smlm.ga.Chromosome} interface. */
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.smlm.results.filter.DirectFilter#setup(int, uk.ac.sussex.gdsc.smlm.results.filter.FilterSetupData[])
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.smlm.results.filter.DirectFilter#validate(uk.ac.sussex.gdsc.smlm.results.filter.PreprocessedPeakResult)
	 */
	@Override
