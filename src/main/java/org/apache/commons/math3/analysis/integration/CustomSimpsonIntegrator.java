 ...
 * rule.
 * <p>
 * Extends the default CustomSimpsonIntegrator to allow the last computed sum to be returned even upon failure.
 *
 * @since 1.2
 */
public class CustomSimpsonIntegrator extends SimpsonIntegrator
{
	...
	/**
	 * Gets the number of increments between the max and min of the range from the last successful computation.
	 *
	 * @return the n
	 */
	public long getN()
