...
public class ParameterStoppingCriteria extends GaussianStoppingCriteria
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.smlm.fitting.nonlinear.stop.GaussianStoppingCriteria#logParameters(double, double, double[])
	 */
	@Override
		...
		if (log != null)
		{
			...
			if (newError <= oldError)
			{
				...
				for (int i = 0; i < peaks; i++)
				{
					...
					{
						final double x = bestA[i * Gaussian2DFunction.PARAMETERS_PER_PEAK + Gaussian2DFunction.ANGLE];
