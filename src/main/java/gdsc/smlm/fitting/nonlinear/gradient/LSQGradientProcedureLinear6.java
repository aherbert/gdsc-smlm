 ...
 */
public class LSQGradientProcedureLinear6 extends LSQGradientProcedureLinear
{
	/**
	 * @param y
	 *            Data to fit
	 ...
	 *            Gradient function
	 */
	public LSQGradientProcedureLinear6(final double[] y, final Gradient1Function func)
	{
		super(y, func);
		if (n != 6)
