...
public class Bessel
{
	...
	public static double J0(final double x)
	{
		...
		if ((ax = Math.abs(x)) < 8.0)
		{
			...
			final double ans2 = 57568490411.0 +
	...
	public static double J1(final double x)
	{
		...
		final double ans2 = 0.04687499995 +
