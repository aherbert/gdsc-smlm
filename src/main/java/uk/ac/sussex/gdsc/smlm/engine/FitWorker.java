...
public class FitWorker implements Runnable, IMultiPathFitResults, SelectedResultStore
{
	...
	public void run(FitJob job)
	{
		...
		else
		{
			...
			if (slice == -1)
			{
				...
				sb.append(((uk.ac.sussex.gdsc.smlm.results.filter.Filter) filter.getMinimalFilter()).toXML()).append("\n");
	...
	private class CandidateSpotFitter
	{
		...
		public MultiPathFitResult.FitResult getResultDoubletMulti(double residualsThreshold)
		{
			...
			if (resultDoubletMulti != null && resultDoubletMulti.status == 0 && resultDoubletMulti.results != null)
			{
				...
				final FitResult doubletFitResult = (uk.ac.sussex.gdsc.smlm.fitting.FitResult) resultDoubletMulti.getData();
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.smlm.results.filter.MultiPathFilter.SelectedResultStore#add(uk.ac.sussex.gdsc.smlm.results.filter.MultiPathFilter.
	 * SelectedResult)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.smlm.results.filter.MultiPathFilter.SelectedResultStore#pass(uk.ac.sussex.gdsc.smlm.results.filter.
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.smlm.results.filter.MultiPathFilter.SelectedResultStore#passMin(uk.ac.sussex.gdsc.smlm.results.filter.
	 * PreprocessedPeakResult)
	 */
	@Override
