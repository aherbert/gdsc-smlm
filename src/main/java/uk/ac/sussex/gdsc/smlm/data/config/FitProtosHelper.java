...
public class FitProtosHelper
{
	...
	/**
	 * Convert noise estimator method to the {@link uk.ac.sussex.gdsc.core.utils.NoiseEstimator.Method }.
	 *
	 * @param method
	 *            the method
	 * @return the method
	...
	/**
	 * Convert search method to the {@link uk.ac.sussex.gdsc.smlm.fitting.nonlinear.MaximumLikelihoodFitter.SearchMethod}.
	 *
	 * @param searchMethod
	 *            the search method
