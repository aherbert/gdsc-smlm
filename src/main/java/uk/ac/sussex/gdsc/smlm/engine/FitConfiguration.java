...
public class FitConfiguration implements Cloneable, IDirectFilter, Gaussian2DFitConfiguration
{
	 ...
	 * (non-Javadoc)
	 *
	 * @see uk.ac.sussex.gdsc.smlm.results.filter.IDirectFilter#setup(uk.ac.sussex.gdsc.smlm.results.filter.FilterSetupData[])
	 */
	@Override
	 ...
	 * 2D PSF) then {@link #setAstigmatismModel(uk.ac.sussex.gdsc.smlm.data.config.PSFProtos.AstigmatismModel)} should be called
