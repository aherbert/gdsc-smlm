...
protoc --java_out=$DIR unit_config.proto psf_config.proto calibration_config.proto results_config.proto
...
perl suppress.pl $DIR/gdsc/smlm/data/config/ResultsConfig.java --unchecked --unused
