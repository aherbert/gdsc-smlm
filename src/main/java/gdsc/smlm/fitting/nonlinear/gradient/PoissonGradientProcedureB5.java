 ...
 */
public class PoissonGradientProcedureB5 extends PoissonGradientProcedure5
{
	 ...
	 *            Gradient function
	 */
	public PoissonGradientProcedureB5(final double[] b, final Gradient1Function func)
	{
		super(func);
		this.b = b;
	}
