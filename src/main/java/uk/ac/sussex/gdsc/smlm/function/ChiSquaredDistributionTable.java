...
public class ChiSquaredDistributionTable {
  ...
  /**
   * The direction of the critical value table. Values more extreme that the critical value in this
   ...
   * @param df the maximum degrees of freedom
   * @param upperTailed Set to true to create upper tailed significance testing (otherwise lower
   *        tailed)
   */
  ...
  /**
   * Creates an upper-tailed Chi squared critical value table. If the test statistic is above the
   * critical value then it will be rejected. A low significance value indicates greater statistical
   * significance, i.e. greater confidence that the observed deviation from the null hypothesis is
   * significant. The test will provide 100 * (1 - significance) percent confidence.
   *
   * @param significance the significance
   * @param maximumDegreesOfFreedom the maximum degrees of freedom
   * @return the chi squared distribution table
   */
  public static ChiSquaredDistributionTable createUpperTailed(double significance,
      int maximumDegreesOfFreedom) {
    return new ChiSquaredDistributionTable(significance, maximumDegreesOfFreedom, true);
  }

  /**
   * Creates a lower-tailed Chi squared critical value table. If the test statistic is below the
   * critical value then it will be rejected. A low significance value indicates greater statistical
   * significance, i.e. greater confidence that the observed deviation from the null hypothesis is
   * significant. The test will provide 100 * (1 - significance) percent confidence.
   *
   ...
   * @return the chi squared distribution table
   */
  public static ChiSquaredDistributionTable createLowerTailed(double significance,
      int maximumDegreesOfFreedom) {
    return new ChiSquaredDistributionTable(significance, maximumDegreesOfFreedom, false);
  }

  /**
   * Checks if the table upper tailed. Values more extreme than this direction (upper/lower) are
   * rejected.
   *
