...
public class MLEGradientCalculator extends GradientCalculator
{
	 ...
	 *
	 * @see uk.ac.sussex.gdsc.smlm.fitting.nonlinear.gradient.GradientCalculator#findLinearised(int[], double[], double[],
	 *      double[][], double[], uk.ac.sussex.gdsc.smlm.function.NonLinearFunction)
	 */
	@Override
	 ...
	 *
	 * @see uk.ac.sussex.gdsc.smlm.fitting.nonlinear.gradient.GradientCalculator#findLinearised(int[], double[], double[],
	 *      double[][], double[], uk.ac.sussex.gdsc.smlm.function.NonLinearFunction, boolean[])
	 */
	@Override
	public double findLinearised(final int[] x, final double[] y, final double[] a, final double[][] alpha,
	 ...
	 * @return The MLE chi-squared value
	 *
	 * @see uk.ac.sussex.gdsc.smlm.fitting.nonlinear.gradient.GradientCalculator#findLinearised(int[], double[], double[], double[],
	 ...
	 *
	 * @see uk.ac.sussex.gdsc.smlm.fitting.nonlinear.gradient.GradientCalculator#findLinearised(int, double[], double[], double[][],
	 *      double[], uk.ac.sussex.gdsc.smlm.function.NonLinearFunction)
	 */
	@Override
	 ...
	 *
	 * @see uk.ac.sussex.gdsc.smlm.fitting.nonlinear.gradient.GradientCalculator#findLinearised(int, double[], double[], double[][],
	 *      double[], uk.ac.sussex.gdsc.smlm.function.NonLinearFunction, boolean[])
	 */
	@Override
	public double findLinearised(final int n, final double[] y, final double[] a, final double[][] alpha,
			final double[] beta, final NonLinearFunction func, boolean[] ignore)
