 ...
 */
public class FastMLEGradient2ProcedureB extends FastMLEGradient2Procedure
{
	 ...
	 */
	public FastMLEGradient2ProcedureB(final double[] x, final double[] b, final Gradient2Function func)
	{
		super(x, func);
		this.b = b;
	}
