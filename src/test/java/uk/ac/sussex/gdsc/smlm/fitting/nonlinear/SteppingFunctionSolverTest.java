...
class SteppingFunctionSolverTest extends BaseSteppingFunctionSolverTest {
  ...
  @SeededTest
  void canFitSingleGaussianEmCcd_x_C__FastMle(RandomSeed seed) {
    fitSingleGaussian(seed, NO_BOUND, CLAMP, FastMLE, NoiseModel.EMCCD);
  }

  @SeededTest
  void canFitSingleGaussianEmCcd_x_DC_FastMle(RandomSeed seed) {
    fitSingleGaussian(seed, NO_BOUND, DYNAMIC_CLAMP, FastMLE, NoiseModel.EMCCD);
  }

  @SeededTest
  void canFitSingleGaussianEmCcd_B_x__FastMle(RandomSeed seed) {
    fitSingleGaussian(seed, BOUNDED, NO_CLAMP, FastMLE, NoiseModel.EMCCD);
  }

  @SeededTest
  void canFitSingleGaussianEmCcd_B_C__FastMle(RandomSeed seed) {
  ...
  @SeededTest
  void canFitSingleGaussianScmos_x_C__FastMle(RandomSeed seed) {
    fitSingleGaussian(seed, NO_BOUND, CLAMP, FastMLE, NoiseModel.SCMOS);
  }

  @SeededTest
  void canFitSingleGaussianScmos_x_DC_FastMle(RandomSeed seed) {
    fitSingleGaussian(seed, NO_BOUND, DYNAMIC_CLAMP, FastMLE, NoiseModel.SCMOS);
  }

  @SeededTest
  void canFitSingleGaussianScmos_B_x__FastMle(RandomSeed seed) {
    fitSingleGaussian(seed, BOUNDED, NO_CLAMP, FastMLE, NoiseModel.SCMOS);
  }

  @SeededTest
  void canFitSingleGaussianScmos_B_C__FastMle(RandomSeed seed) {
    fitSingleGaussian(seed, BOUNDED, CLAMP, FastMLE, NoiseModel.SCMOS);
  }

  @SeededTest
  void canFitSingleGaussianScmos_B_DC_FastMle(RandomSeed seed) {
  ...
  @SeededTest
  void fitSingleGaussianEmCcd_x_x__LseLvmBetterThanFastLogMleLvm(RandomSeed seed) {
  ...
  @SeededTest
  void fitSingleGaussianEmCcd_x_x__MleLvmBetterThanFastLogMleLvm(RandomSeed seed) {
