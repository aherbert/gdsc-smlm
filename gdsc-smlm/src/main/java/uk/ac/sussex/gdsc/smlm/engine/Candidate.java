...
class Candidate extends Spot {
   ...
   * @param paramDevs the param deviations
   * @param error the error
   * @param noise the noise
   * @param meanIntensity the mean intensity
   * @param valid the valid
   */
  public Candidate(int x, int y, int index, float[] params, float[] paramDevs, double error,
      float noise, float meanIntensity, boolean valid) {
    super(x, y, 0, 0);
    this.index = index;
    this.params = params;
   ...
   */
  public Candidate createFitted(int x, int y, int index, float[] params, float[] paramDevs,
      double error, float noise, float meanIntensity, boolean valid) {
