...
public abstract class FastLog {
  ...
  /**
   * Gets the scale to convert from log2 to logB (the base given by {@link #getBase()}) by
   * multiplication.
   *
   * @return the scale
   */
  ...
  /**
   * Gets the number of most significant bits to keep from the mantissa, i.e. the binary precision
   * of the floating point number before computing the log.
   *
