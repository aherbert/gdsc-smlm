...
public class TSFPeakResultsReader
{
	...
	static
	{
		...
		cameraTypeMap[CameraType.EMCCD.ordinal()] = uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.EMCCD;
		cameraTypeMap[CameraType.SCMOS.ordinal()] = uk.ac.sussex.gdsc.smlm.data.config.CalibrationProtos.CameraType.SCMOS;
		...
		locationUnitsMap = new uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.DistanceUnit[LocationUnits.values().length];
		...
		locationUnitsMap[LocationUnits.PIXELS.ordinal()] = uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.DistanceUnit.PIXEL;
		intensityUnitsMap = new uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit[IntensityUnits.values().length];
		intensityUnitsMap[IntensityUnits.COUNTS.ordinal()] = uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit.COUNT;
		intensityUnitsMap[IntensityUnits.PHOTONS.ordinal()] = uk.ac.sussex.gdsc.smlm.data.config.UnitProtos.IntensityUnit.PHOTON;
	}
