...
public class SumFilter extends BaseFilter
{
	...
	{
		// Note: Speed tests show that this method is only marginally faster than rollingBlockSumNxNInternal.
	 ...
	 *            The block size
	 */
	public void rollingBlockSumNxNInternal(float[] data, final int maxx, final int maxy, final int n)
	{
