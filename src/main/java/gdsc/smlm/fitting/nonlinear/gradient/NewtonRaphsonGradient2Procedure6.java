 ...
 */
public class NewtonRaphsonGradient2Procedure6 extends NewtonRaphsonGradient2Procedure
{
	/**
	 * @param x
	 ...
	 */
	public NewtonRaphsonGradient2Procedure6(final double[] x, final Gradient2Function func)
	{
		super(x, func);
		if (n != 6)
	...
	public void execute(double uk, double[] duk_dt, double[] d2uk_dt2)
	{
		...
		d2[5] += d2uk_dt2[5] * xk_uk_minus1 - duk_dt[5] * duk_dt[5] * xk_uk2;
	}
