...
public class LoadLocalisations implements PlugIn
{
    ...
    public static class LocalisationList extends ArrayList<Localisation>
    {
        ...
        public MemoryPeakResults toPeakResults(String name)
        {
            ...
            final TypeConverter<DistanceUnit> distanceConverter = calibrationWriter
                    .getDistanceConverter(DistanceUnit.NM);
            ...
            if (size() > 0)
            {
                ...
                for (int i = 0; i < size(); i++)
                {
                    ...
                    final AttributePeakResult peakResult = new AttributePeakResult(l.t, (int) x, (int) y, 0, 0, 0, 0,
                            params, null);
