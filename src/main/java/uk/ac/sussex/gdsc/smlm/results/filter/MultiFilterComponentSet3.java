 ...
 */
public class MultiFilterComponentSet3 implements MultiFilterComponentSet {
  ...
  /**
   * Instantiates a new multi filter component set for 3 components.
   *
   * @param components the components
   */
  MultiFilterComponentSet3(MultiFilterComponent[] components) {
   ...
   */
  MultiFilterComponentSet3(MultiFilterComponentSet3 source) {
  ...
  public MultiFilterComponentSet copy() {
    return new MultiFilterComponentSet3(this);
  }
}
