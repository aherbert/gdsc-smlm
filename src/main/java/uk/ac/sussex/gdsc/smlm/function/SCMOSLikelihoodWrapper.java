...
public class SCMOSLikelihoodWrapper extends LikelihoodWrapper {
   ...
   */
  public SCMOSLikelihoodWrapper(NonLinearFunction f, double[] a, double[] k, int n, float[] var,
      float[] g, float[] o) {
    super(f, a, k, n);
   ...
   *
   * @param u the expected value (number of photoelectrons)
   * @param var the variance of the pixel
   * @param g the gain of the pixel
   * @param o the offset of the pixel
   * @param k The observed value (count from the sCMOS pixel)
