 ...
 * iterations with a reduced error move the fitted X,Y coordinates by less than a specified distance
 * (delta). <p> The criteria also ensure that signal, coordinates and peak-widths are held positive,
