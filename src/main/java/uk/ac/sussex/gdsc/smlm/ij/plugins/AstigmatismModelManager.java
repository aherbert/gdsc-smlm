...
public class AstigmatismModelManager implements PlugIn
{
    ...
    private static PlotWindow plot(WindowOrganiser wo, double[] z, String yTitle, double[] y1, String y1Title,
            double[] y2, String y2Title)
    {
    ...
    private boolean doCurveFit()
    {
        ...
        final double d = (estimateD(focalPlaneXindex, fitZ, smoothSx) + estimateD(focalPlaneYindex, fitZ, smoothSy)) /
                2;
