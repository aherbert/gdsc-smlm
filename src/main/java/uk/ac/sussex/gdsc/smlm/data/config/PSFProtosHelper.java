...
public class PSFProtosHelper
{
            ...
            DistanceUnit sDistanceUnit) throws ConversionException
    {
        ...
        final TypeConverter<DistanceUnit> zc = UnitConverterFactory.createConverter(model.getZDistanceUnit(),
                zDistanceUnit, model.getNmPerPixel());
        final TypeConverter<DistanceUnit> sc = UnitConverterFactory.createConverter(model.getSDistanceUnit(),
                sDistanceUnit, model.getNmPerPixel());
     ...
     * <p>
     * Note that the nm/pixel or the units are not contained within the PSF parameters.
     *
     * @param model
     *            the model
     * @param zDistanceUnit
     ...
     *             if the units cannot be converted
     */
    public static PSF createPSF(AstigmatismModel model, DistanceUnit zDistanceUnit, DistanceUnit sDistanceUnit)
            throws ConversionException
    {
    ...
    private static void addParameter(PSF.Builder psf, PSFParameter.Builder param, String name, double value,
            PSFParameterUnit unit)
    {
        param.setName(name);
     ...
     * <p>
     * Note that the nm/pixel and the units are not contained within the PSF parameters so these must be input as
     * parameters.
     *
     * @param psf
     *            the psf
     * @param zDistanceUnit
     *            the input z distance unit
     * @param sDistanceUnit
     *            the output s distance unit
     * @param nmPerPixel
     *            the nm per pixel
     * @return the model
     ...
     */
    public static AstigmatismModel createModel(PSF psf, DistanceUnit zDistanceUnit, DistanceUnit sDistanceUnit,
            double nmPerPixel) throws ConfigurationException
    {
