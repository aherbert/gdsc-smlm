...
public class FIRE implements PlugIn
{
            ...
            double fourierImageScale, int imageSize)
    {
        ...
        for (int t = step; t <= maxT - step; t += step)
        {
            ...
            final FireResult result = f.calculateFireNumber(fourierMethod, samplingMethod, thresholdMethod,
                    fourierImageScale, imageSize);
    ...
    private void runQEstimation()
    {
        ...
        if (fitPrecision)
        {
            ...
            if (sampleDecay)
            {
                ...
                final double meanSumOfSquares = (precision.getSumOfSquares() /
                        (images.nmPerPixel * images.nmPerPixel)) / precision.getN();
            ...
            final double nmPerPixel)
    {
        ...
        if (macroOptions != null)
        {
            ...
            final double qValue = Double
                    .parseDouble(Macro.getValue(macroOptions, KEY_Q, Double.toString(qplot.qValue)));
