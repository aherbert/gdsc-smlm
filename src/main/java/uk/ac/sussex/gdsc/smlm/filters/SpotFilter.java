...
public abstract class SpotFilter {
  ...
  /**
   * Return true if the intensity value of the candidate spots is absolute, i.e. is the height of
   * the candidate maximum using the original data scale. Otherwise the intensity is relative, for
   * example this could be relative to the local background.
   *
