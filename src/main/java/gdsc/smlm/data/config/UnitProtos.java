...
public final class UnitProtos
{
	...
	public enum DistanceUnit implements com.google.protobuf.ProtocolMessageEnum
	{
		...
		private static final com.google.protobuf.Internal.EnumLiteMap<DistanceUnit> internalValueMap = new com.google.protobuf.Internal.EnumLiteMap<DistanceUnit>()
		{
			@Override
		...
		{
			return gdsc.smlm.data.config.UnitProtos.getDescriptor().getEnumTypes().get(0);
		}
	 ...
	 */
	public enum IntensityUnit implements com.google.protobuf.ProtocolMessageEnum
	{
		/**
		 * <pre>
		 * Not available
		...
		public static com.google.protobuf.Internal.EnumLiteMap<IntensityUnit> internalGetValueMap()
		{
			return internalValueMap;
		}

		private static final com.google.protobuf.Internal.EnumLiteMap<IntensityUnit> internalValueMap = new com.google.protobuf.Internal.EnumLiteMap<IntensityUnit>()
		{
			@Override
		...
		public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor()
		{
			return gdsc.smlm.data.config.UnitProtos.getDescriptor().getEnumTypes().get(1);
		}

		private static final IntensityUnit[] VALUES = values();

		public static IntensityUnit valueOf(com.google.protobuf.Descriptors.EnumValueDescriptor desc)
		{
			if (desc.getType() != getDescriptor())
			{
				throw new java.lang.IllegalArgumentException("EnumValueDescriptor is not for this type.");
	 ...
	 */
	public enum AngleUnit implements com.google.protobuf.ProtocolMessageEnum
	{
		/**
		 * <pre>
		 * Not available
		...
		public static com.google.protobuf.Internal.EnumLiteMap<AngleUnit> internalGetValueMap()
		{
			return internalValueMap;
		}

		private static final com.google.protobuf.Internal.EnumLiteMap<AngleUnit> internalValueMap = new com.google.protobuf.Internal.EnumLiteMap<AngleUnit>()
		{
			@Override
		...
		public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor()
		{
			return gdsc.smlm.data.config.UnitProtos.getDescriptor().getEnumTypes().get(2);
		}

		private static final AngleUnit[] VALUES = values();

		public static AngleUnit valueOf(com.google.protobuf.Descriptors.EnumValueDescriptor desc)
		{
			if (desc.getType() != getDescriptor())
			{
				throw new java.lang.IllegalArgumentException("EnumValueDescriptor is not for this type.");
	...
	public enum TimeUnit implements com.google.protobuf.ProtocolMessageEnum
	{
		...
		private static final com.google.protobuf.Internal.EnumLiteMap<TimeUnit> internalValueMap = new com.google.protobuf.Internal.EnumLiteMap<TimeUnit>()
		{
			@Override
		...
		public static final com.google.protobuf.Descriptors.EnumDescriptor getDescriptor()
		{
			return gdsc.smlm.data.config.UnitProtos.getDescriptor().getEnumTypes().get(3);
		}
