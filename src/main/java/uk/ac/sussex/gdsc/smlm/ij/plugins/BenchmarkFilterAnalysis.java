        ...
        FullScoreFunction<FilterScore>
{
    ...
    private static void expandFilters()
    {
        ...
        final StringBuilder sb = new StringBuilder(
                "The filter file contains potential triples of min:max:increment.\n \n");
            ...
            double rangeReduction)
    {
        ...
        else
        {
            ...
            final Settings settings = new Settings(filterSets, resultsList, failCount, residualsThreshold,
                    duplicateDistance, duplicateDistanceAbsolute, plotTopN, summaryDepth, criteriaIndex, criteriaLimit,
                    scoreIndex, evolveSetting);
            ...
            if (runAlgorithm)
            {
                ...
                if (filterSet.size() < populationSize)
                {
                    ...
                    final double[][] sample = SearchSpace.sampleWithoutRounding(dimensions,
                            populationSize - filters.size(), null);
            ...
            DirectFilter filter)
    {
        ...
        {
            final double range = simulationParameters.a * BenchmarkSpotFit.distanceInPixels * upperMatchDistance /
                    100.0;
