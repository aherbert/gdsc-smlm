...
public class StandardValueProcedure implements ValueProcedure {
   ...
   * @return the values
   */
  public double[] getValues(ValueFunction function, double[] parameters) {
   ...
   */
  public void getValues(ValueFunction function, double[] parameters, double[] buffer, int offset) {
