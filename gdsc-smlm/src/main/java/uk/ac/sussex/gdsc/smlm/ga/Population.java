...
public class Population<T extends Comparable<T>> {
   ...
   */
  public Chromosome<T> evolve(Mutator<T> mutator, Recombiner<T> recombiner,
      FitnessFunction<T> fitnessFunction, SelectionStrategy<T> selectionStrategy,
  ...
  private void grow(SelectionStrategy<T> selectionStrategy, Mutator<T> mutator,
    ...
    final ArrayList<Chromosome<T>> newIndividuals =
