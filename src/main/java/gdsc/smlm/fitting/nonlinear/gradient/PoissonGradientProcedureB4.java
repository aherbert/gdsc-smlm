 ...
 */
public class PoissonGradientProcedureB4 extends PoissonGradientProcedure4
{
	 ...
	 *            Gradient function
	 */
	public PoissonGradientProcedureB4(final double[] b, final Gradient1Function func)
	{
		super(func);
		this.b = b;
	}
