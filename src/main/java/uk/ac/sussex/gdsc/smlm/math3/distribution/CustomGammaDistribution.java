...
public class CustomGammaDistribution extends AbstractRealDistribution {
   ...
   * {@inheritDoc}
   *
   * <p>The implementation of this method is based on: <ul> <li> <a
   ...
   * {@inheritDoc}
   *
   * <p>For shape parameter {@code alpha} and scale parameter {@code beta}, the mean is
   * {@code alpha * beta}.
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * <p>For shape parameter {@code alpha} and scale parameter {@code beta}, the variance is
   * {@code alpha * beta^2}.
   *
   * @return {@inheritDoc}
   */
